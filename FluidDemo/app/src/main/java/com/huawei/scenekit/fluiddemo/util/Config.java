...
public class Config {
     ...
     * Particle radius.
     */
    public static final float NODE_RADIUS = 0.045f;
    ...
    /**
     * Max node count of WATCH.
     */
    public static final int MAX_NODE_COUNT_WATCH = 1500;
     ...
     */
    public static final String DEFAULT_TEXTURE_NAME = "textures/wt.jpg";

    /**
     * HANDS_TEXTURE_NAME
     */
    public static final String HANDS_TEXTURE_NAME = "textures/A005_035.png";

    /**
     * CANVAS_TEXTURE
     */
    public static HashMap<SurfaceViewId, String> CANVAS_TEXTURE = new HashMap<SurfaceViewId, String>() {
        {
            put(SurfaceViewId.One, "textures/canvas2.jpg");
            put(SurfaceViewId.Two, "textures/canvas2.jpg");
            put(SurfaceViewId.Default, DEFAULT_TEXTURE_NAME);
        }
    };
     ...
     * SurfaceViewId
     */
    public static enum SurfaceViewId {
        One,
        Two,
        Three,
        Four,
